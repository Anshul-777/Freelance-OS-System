...
from models import (
    ...
    InvoiceItem, Expense, Note, Workspace, UserWorkspace,
...
def seed_database(db: Session):
    ...
    workspace = Workspace(
        name=settings.DEMO_COMPANY or f"{user.full_name}'s Workspace",
        slug="demo-workspace",
        owner_id=user.id
    )
    db.add(workspace)
    ...
    for cd in clients_data:
        client = Client(user_id=user.id, workspace_id=workspace.id, **cd)
        db.add(client)
    ...
    # ─── Create Expenses ─────────────────────────────────────────────────────
    expenses_data = [
        {"category": ExpenseCategory.SOFTWARE_SUBSCRIPTION, "description": "Adobe Creative Cloud", "amount": 54.99, "date": today - timedelta(days=5), "vendor": "Adobe Inc.", "is_billable": False},
        {"category": ExpenseCategory.SOFTWARE_SUBSCRIPTION, "description": "Figma Professional Plan", "amount": 15.00, "date": today - timedelta(days=5), "vendor": "Figma Inc.", "is_billable": False},
        {"category": ExpenseCategory.SOFTWARE_SUBSCRIPTION, "description": "Linear (Project Management)", "amount": 8.00, "date": today - timedelta(days=5), "vendor": "Linear", "is_billable": False},
        {"category": ExpenseCategory.SOFTWARE_SUBSCRIPTION, "description": "GitHub Pro", "amount": 4.00, "date": today - timedelta(days=5), "vendor": "GitHub Inc.", "is_billable": False},
        {"category": ExpenseCategory.SOFTWARE_SUBSCRIPTION, "description": "Vercel Pro Plan", "amount": 20.00, "date": today - timedelta(days=5), "vendor": "Vercel Inc.", "is_billable": True},
        ...
        {"category": ExpenseCategory.OFFICE_RENT, "description": "WeWork Day Pass x4", "amount": 120.00, "date": today - timedelta(days=15), "vendor": "WeWork", "is_billable": False},
        {"category": ExpenseCategory.OFFICE_RENT, "description": "Office supplies & stationery", "amount": 67.45, "date": today - timedelta(days=22), "vendor": "Staples", "is_billable": False},
        ...
        {"category": ExpenseCategory.MARKETING_ADVERTISING, "description": "LinkedIn Premium (1 month)", "amount": 39.99, "date": today - timedelta(days=5), "vendor": "LinkedIn", "is_billable": False},
        {"category": ExpenseCategory.CONTRACTOR_PAYMENTS, "description": "SEO Copywriter - Nexus Blog Posts", "amount": 650.00, "date": today - timedelta(days=8), "vendor": "Freelance SEO Writer", "is_billable": True},
        {"category": ExpenseCategory.SOFTWARE_SUBSCRIPTION, "description": "Loom Pro (Video Messaging)", "amount": 12.50, "date": today - timedelta(days=5), "vendor": "Loom Inc.", "is_billable": False},
