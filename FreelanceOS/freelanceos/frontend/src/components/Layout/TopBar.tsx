    ...
    <header className="h-16 bg-white border-b border-slate-200 flex items-center px-6 gap-4 flex-shrink-0 z-30 sticky top-0">
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          className="hidden sm:flex items-center gap-2 px-4 py-2.5 text-sm text-slate-600 bg-slate-50 hover:bg-slate-100 rounded-xl transition-colors border border-slate-200 hover:border-brand-300 shadow-sm hover:shadow-md font-medium"
        >
          <Search size={16} className="text-slate-500" />
          <span className="hidden md:block">Search projects, clients…</span>
          <span className="md:hidden">Search…</span>
          <kbd className="hidden xl:flex items-center gap-0.5 text-xs text-slate-400 bg-white px-2 py-1 rounded border border-slate-200 ml-auto">
            ⌘K
          </kbd>
        </button>
        ...
        <button 
          ...
          title="Notifications"
          className="relative p-2 rounded-xl hover:bg-slate-100 text-slate-500 hover:text-slate-700 hover:text-brand-600 transition-all group">
          <Bell size={18} className="group-hover:scale-110 transition-transform" />
          <span className="absolute top-1.5 right-1.5 w-2 h-2 bg-brand-600 rounded-full border border-white animate-pulse" />
        </button>
        ...
        <button
          ...
          title="User settings"
          className="avatar w-9 h-9 text-sm hover:opacity-90 transition-opacity ring-2 ring-transparent hover:ring-brand-300 ring-offset-1 dynamic-bg"
          style={{ '--dynamic-bg-color': avatarColor } as React.CSSProperties}>
          {initials}
        </button>
      </div>
