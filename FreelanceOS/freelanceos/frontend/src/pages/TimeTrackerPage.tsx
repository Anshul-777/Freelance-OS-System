        ...
        <div className="space-y-4">
          ...
          <div className="card p-5">
            ...
            <div className={classNames(
              'rounded-2xl p-6 text-center mb-4 transition-all duration-300 shadow-lg',
              activeTimer.running
                ? 'bg-gradient-to-br from-brand-600 via-brand-500 to-brand-700 scale-100 hover:scale-102'
                : 'bg-gradient-to-br from-slate-100 to-slate-50 hover:shadow-xl'
            )}>
              <p className={classNames(
                'font-mono text-6xl font-bold tracking-tighter',
                activeTimer.running ? 'text-white animate-pulse' : 'text-slate-800'
              )}>
                {formatElapsed(elapsed)}
              </p>
              {activeTimer.running && (
                <p className="text-brand-100 text-sm mt-3 font-semibold truncate">
                  ⏱️ {activeTimer.projectName || 'General work'}
                </p>
              )}
            </div>
            ...
            {!activeTimer.running ? (
              <div className="space-y-3">
                <input
                  ...
                  className="input-field font-medium placeholder:font-normal"
                />
                <select
                  value={timerProject}
                ...
                <button
                  ...
                  className="btn-primary w-full justify-center py-3 font-bold text-sm hover:shadow-lg active:scale-95 transition-all">
              ...
              <div className="space-y-3">
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-red-50 border-2 border-red-200 text-red-600 font-bold text-sm rounded-xl hover:bg-red-600 hover:text-white hover:border-red-600 transition-all active:scale-95 shadow-sm">
